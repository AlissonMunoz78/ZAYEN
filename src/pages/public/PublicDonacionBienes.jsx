      ...
      >
        {done ? (
          <div style={{ textAlign: "center" }}>
            ...
            >
              El equipo del museo revisará tu donación. ¡Gracias por tu
              generosidad!
            </p>
            <Link
              to="/"
          ...
          <>
            ...
            >
              <div
                style={{
                  ...
                  border: "0.5px solid rgba(107,53,200,0.2)",
                  display: "flex",
                  alignItems: "center",
                  justifyContent: "center",
                }}
              >
                <FaBookOpen
                  style={{ color: "var(--c-purple)", fontSize: "22px" }}
                />
              </div>
              <div>
                <div
            ...
            <form onSubmit={handleSubmit}>
              {[
                ["nombreDonante", "Nombre del donante", "María García"],
                ["institucion", "Institución", "Empresa XYZ"],
              ].map(([name, label, ph]) => (
              ...
              <div style={{ marginBottom: "20px" }}>
                ...
                <textarea
                  ...
                  onChange={h}
                  placeholder="Describe detalladamente el bien..."
                  rows="3"
                  className="input-field"
